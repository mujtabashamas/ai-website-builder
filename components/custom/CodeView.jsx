...
function CodeView({ jobId, loading }) {
    const { id } = useParams();
    ...
    useEffect(() => {
        if (!jobId) return;
        console.log('CodeView: Job ID changed:', jobId);
        ...
        const poll = async () => {
            ...
            while (status === 'pending') {
                console.log('CodeView: polling job status...');
                ...
                try {
                    ...
                    console.error('CodeView: Error polling job status:', e);
                    status = 'done';
            ...
            if (result && result.files) {
                ...
                console.error('CodeView: Error in result:', result.error);
            }
        };
